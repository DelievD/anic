...
//}
async function loadMobilenet() {
    model = await tf.loadLayersModel('mNetModel_js/model.json');
...
//      const predictions = mobilenet.predict(activation);
//        console.log(activation)
//        alert (activation.as1D());
      return activation.as1D().argMax();
    });
